...
export const oralMedication: MockData = {
  ...
  directions: "Please review your current medications below and confirm they are correct",
  items: [
    ...
    { title: "Doxycycline 50mg", subtext: "Blepharitis, rosacea-related eye disease", type: "oral" },
  ],
};
